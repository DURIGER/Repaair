...
namespace ComputerRepairRequests
{
    public partial class OperatorForm : Form
    {
        ...
        public OperatorForm(string login)
        {
            InitializeComponent();
            userLogin = login;
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Пожалуйста, выберите заявку для удаления.", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }

        private void buttonOpenAudit_Click(object sender, EventArgs e)
        {
